...
describe('SignUp Controller', () => {
  ...
  test('Shold return 400 if confirmation password fails', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
  ...
  test('Shold return 400 if an invalid email is provide', async () => {
  ...
  test('Shold call EmailValidator with a correct email', async () => {
    const { sut, emailValidatorStub } = makeSut()
  ...
  test('Shold return 500 if EmailValidator trows', async () => {
    const { sut, emailValidatorStub } = makeSut()
  ...
  test('Shold return 500 if AddAccount trows', async () => {
  ...
  test('Shold call AddAccount with a correct values', async () => {
    const { sut, addAccountStub } = makeSut()
